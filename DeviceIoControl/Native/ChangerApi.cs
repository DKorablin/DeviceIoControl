...
namespace AlphaOmega.Debug.Native
{
	...
	public static class ChangerApi
	{
		...
		{
			/// <summary>The device manufacturer's name</summary>
			/// <remarks>This is acquired directly from the device inquiry data</remarks>
			[MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
			public Byte[] VendorId;
			/// <summary>The product identification, as defined by the vendor</summary>
			/// <remarks>This is acquired directly from the device inquiry data</remarks>

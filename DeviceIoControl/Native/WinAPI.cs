...
namespace AlphaOmega.Debug
{
	...
	{
		/// <summary>The MEDIA_TYPE enumerators are used in conjunction with the <see cref="Constant.IOCTL_DISC.FORMAT_TRACKS"/> request to format the specified set of contiguous tracks on the disk</summary>
		...
		public enum METHOD : Byte
		{
			...
			/// <summary>Specifies the direct I/O method, which is typically used for reading or writing large amounts of data, using DMA or PIO, that must be transferred quickly</summary>
			OUT_DIRECT = 2,
			/// <summary>Specifies neither buffered nor direct I/O</summary>
			/// <remarks>
		...
		public enum FILE_ACCESS : UInt16
		{
			...
			/// <remarks>Can be used with <see cref="FILE_ACCESS.WRITE_ACCESS"/></remarks>
			READ_ACCESS = 0x0001,
			/// <summary>Request write access</summary>
			/// <remarks>Can be used with <see cref="FILE_ACCESS.READ_ACCESS"/></remarks>
			WRITE_ACCESS = 0x0002,
		}

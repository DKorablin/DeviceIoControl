...
namespace AlphaOmega.Debug.Native
{
	...
	{
		/// <summary>Represents volume data. This structure is passed to the <see cref="Constant.FSCTL.GET_NTFS_VOLUME_DATA"/> control code</summary>
		...
		/// <summary>Contains the starting LCN to the<see cref="Constant.FSCTL.GET_VOLUME_BITMAP"/> control code</summary>
		[StructLayout(LayoutKind.Sequential)]
		...
		/// <summary>Represents the occupied and available clusters on a disk. This structure is the output buffer for the <see cref="Constant.FSCTL.GET_VOLUME_BITMAP"/> control code</summary>
		...
		public struct VOLUME_BITMAP_BUFFER
		{
			...
			/// </summary>
			/// <remarks>
			/// It is necessary to return an array of bytes, and overlay the first structure on the array of bytes, and then read the buffer.
			/// But if you break it into pieces, say, 512 bytes each, then reading the entire array can take several minutes. It's easier to immediately transfer a large enough array.
			/// </remarks>
		...
		public struct FILESYSTEM_STATISTICS
		{
			...
			/// For example, if the size of <see cref="FILESYSTEM_STATISTICS"/> is 0x38, the size of <see cref="NTFS_STATISTICS"/> is 0xd4, and if there are 2 processors, the buffer allocated must be 0x280.
			...
			/// <summary>This value includes sub-read operations</summary>
			/// <remarks>The number of read operations on user files</remarks>
			[FieldOffset(16)]
			...
			/// <summary>This value includes sub-write operations</summary>
			/// <remarks>The number of write operations on user files</remarks>
			[FieldOffset(28)]
			...
			/// <summary>This value includes sub-read operations</summary>
			/// <remarks>The number of read operations on metadata files</remarks>
			[FieldOffset(40)]
			...
			/// <summary>This value includes sub-write operations</summary>
			/// <remarks>The number of write operations on metadata files</remarks>
			[FieldOffset(52)]
		...
		public struct FILESYSTEM_STATISTICS_EX
		{
			...
			/// <summary>The size of this structure plus the size of the file system-specific structure that follows this structure, multiplied by the number of processors</summary>
			/// <remarks>
			/// This value must be a multiple of 64. For example, if the size of <see cref="FILESYSTEM_STATISTICS"/> is 0x38, the size of <see cref="NTFS_STATISTICS"/> is 0xd4, and if there are 2 processors, the buffer allocated must be 0x280.
			/// sizeof(FILESYSTEM_STATISTICS) = 0x38
			/// sizeof(NTFS_STATISTICS) = 0xd4
			/// Total Size = 0x10c
			/// size of the complete structure = 0x140 (which is the aligned length, a multiple of 64)

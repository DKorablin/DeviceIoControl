...
namespace AlphaOmega.Debug.Native
{
	...
	{
		/// <summary>Indicates the properties of a storage device or adapter to retrieve as the input buffer passed to the <see cref="Constant.IOCTL_STORAGE.QUERY_PROPERTY"/> control code</summary>
		...
		public struct STORAGE_PROPERTY_QUERY
		{
			...
			/// <summary>Contains flags indicating the type of query to be performed as enumerated by the <see cref="STORAGE_QUERY_TYPE"/> enumeration</summary>
		...
		public struct STORAGE_DEVICE_DESCRIPTOR
		{
			...
			/// <summary>Specifies an enumerator value of type <see cref="STORAGE_BUS_TYPE"/> that indicates the type of bus to which the device is connected</summary>
		...
		/// <summary>
		/// The DEVICE_COPY_OFFLOAD_DESCRIPTOR structure is one of the query result structures returned from an <see cref="Constant.IOCTL_STORAGE.QUERY_PROPERTY"/> request.

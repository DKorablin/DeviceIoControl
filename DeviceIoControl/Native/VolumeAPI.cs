...
namespace AlphaOmega.Debug.Native
{
	...
	{
		/// <summary>Represents a physical location on a disk. It is the output buffer for the <see cref="Constant.IOCTL_VOLUME.GET_VOLUME_DISK_EXTENTS"/> control code</summary>

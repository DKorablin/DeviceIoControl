...
namespace AlphaOmega.Debug
{
	...
	public class Storage
	{
		...
		{
			return this.Device.IoControl<StorageApi.STORAGE_HOTPLUG_INFO>(Constant.IOCTL_STORAGE.GET_HOTPLUG_INFO, null);
		}
		...
		{
			return this.Device.IoControl<StorageApi.STORAGE_PREDICT_FAILURE>(Constant.IOCTL_STORAGE.PREDICT_FAILURE, null);
		}
		...
		{//ERROR: The program issued a command but the command length is incorrect
			return this.Device.IoControl<StorageApi.STORAGE_HW_FIRMWARE_INFO>(Constant.IOCTL_STORAGE.FIRMWARE_GET_INFO, null);
		}
	}
}